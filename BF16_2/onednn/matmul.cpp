...
void matmul_example(dnnl::engine::kind engine_kind)
{
    ...
    FILE *fp;
    if ((fp = fopen("./bf16_onednn.txt", "w")) == NULL)
    {
    ...
    for (int j = 0; j < 10; j++)
    {
        ...
        // const memory::dim M = 2 << (j + 5), K = 2 << (j + 5), N = 2 << (j + 5);
        ...
        printf("onednn_bf16:  N=%-10d M1= %-10d K1=%-10d M2= %-10d K2=%-10d M3= %-10d K3=%-10d flops = %-10.3lf effic= %.3lf %\n",
