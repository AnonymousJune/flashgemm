...
static void FLASHGEMM_BF16_KERNELm12xn32xk2(float *C, uint16_t *A, uint16_t *B, long M, long N, long K, long LK, long LN, uint16_t *Bc, long k_tag) // edge case m4n32k2
{
	asm volatile(
