...
void NPACK_m12xk(float *A, float *Ac, int K, int LK);
void NPACK_m8xk(float *A, float *Ac, int K, int LK);
void NPACK_m4xk(float *A, float *Ac, int K, int LK);
// void NPACK_m2xk(float *A, float *Ac, int K, int LK);
void NPACK_m1xk(float *A, float *Ac, int K, int LK);
